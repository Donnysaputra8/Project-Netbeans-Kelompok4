...
public Pemesanan plgn = null;
    ...
    Object[] Baris ={"Id Pelanggan", "Nama Pelanggan", "Alamat", "No. Telp", "Email", "Perusahaan"};
    tabmode = new DefaultTableModel(null, Baris);
    String cariitem=txtcari.getText();
    
    try {
         String sql = "SELECT * FROM pelanggan where id_pel like '%"+cariitem+"%' or nm_pel like'%"+cariitem+"%' order by id_pel asc";
    ...
    private void tblpelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpelangganMouseClicked
        ...
        plgn.idp = tblpelanggan.getValueAt(tabelPelanggan, 0).toString();
        plgn.nmp = tblpelanggan.getValueAt(tabelPelanggan, 1).toString();
        plgn. almt = tblpelanggan.getValueAt(tabelPelanggan, 2). toString();
        plgn.telp = tblpelanggan.getValueAt(tabelPelanggan, 3).toString();
        plgn.eml = tblpelanggan.getValueAt(tabelPelanggan, 4).toString();
        plgn.perushn = tblpelanggan.getValueAt(tabelPelanggan, 5).toString();
